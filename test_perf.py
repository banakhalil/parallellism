...
def generate_huge_data():
    ...
    if current_count < 10000:
        ...
        order_field = 'cost' if hasattr(Order, 'cost') else 'total_price' if hasattr(
        ...
        print(
            f" Data generated successfully! Total now: {Order.objects.count()} orders.")
    else:
...
if __name__ == '__main__':
    ...
    scheduler.add_job(start_scheduled_benchmarks, 'cron',
